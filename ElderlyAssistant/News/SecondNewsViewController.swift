...
class SecondNewsViewController: UITableViewController{
    let firstView = 6
    ...
    //let loadingView: LoadingView = LoadingView(frame: CGRect(x: UIScreen.main.bounds.width/2-50, y: UIScreen.main.bounds.height/2-50, width: 100, height: 100))
    ...
    override func viewDidLoad() {
        ...
        refreshControl.addTarget(self, action: #selector(SecondNewsViewController.getDataSource), for: UIControlEvents.valueChanged)
    ...
    @objc func getDataSource(){
        ...
        do{
            ...
            let url = URL(string: "http://route.showapi.com/96-109?showapi_appid=45739&tid=2&keyword=&page=1&showapi_sign=96bc4c4d4ff14934bd8457f7ae343a86")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.DetailID = newId
         vc.Tname = DataSource[0].Tname
        vc.view.backgroundColor = UIColor.white
        self.navigationItem.backBarButtonItem?.title = "dasdas"
        self.navigationController?.pushViewController(vc, animated: true)
